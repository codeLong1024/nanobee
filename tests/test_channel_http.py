...
class TestHTTPEndpoints(AioHTTPTestCase):
    ...
    async def test_completions_streaming(self) -> None:
        ...
        async def _streaming_handle(message, context_id="default", *, channel="direct", media=None, on_stream=None, on_stream_end=None, on_progress=None, sender_id="user", session_id=None, metadata=None):
            if on_stream:
