...
_LEGACY_MODULE_ALIASES = {
    "webui_thread_disk": "nanobee.webui.thread_disk",
    "webui_transcript": "nanobee.webui.transcript",
    "webui_turn_helpers": "nanobee.session.webui_turns",
}
