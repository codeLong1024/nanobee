...
from nanobee.config.schema import Config, InlineFallbackConfig, ModelPresetConfig
from nanobee.providers.base import LLMProvider
from nanobee.providers.fallback_provider import FallbackProvider
...
def _make_provider_core(
    ...
    *,
    ...
    if backend == "openai_codex":
        from nanobee.providers.openai_codex_provider import OpenAICodexProvider

        provider = OpenAICodexProvider(default_model=model)
    elif backend == "azure_openai":
        from nanobee.providers.azure_openai_provider import AzureOpenAIProvider
        ...
        from nanobee.providers.github_copilot_provider import GitHubCopilotProvider

        provider = GitHubCopilotProvider(default_model=model)
    elif backend == "anthropic":
        from nanobee.providers.anthropic_provider import AnthropicProvider
        ...
        from nanobee.providers.bedrock_provider import BedrockProvider
