"""JSON Schema fragment types: all subclass :class:`~nanobee.agent.tools.base.Schema` for descriptions and constraints on tool parameters.

- ``to_json_schema()``: returns a dict compatible with :meth:`~nanobee.agent.tools.base.Schema.validate_json_schema_value` /
  :class:`~nanobee.agent.tools.base.Tool`.
...
Shared validation and fragment normalization are on the class methods of :class:`~nanobee.agent.tools.base.Schema`.
...
from nanobee.agent.tools.base import Schema
